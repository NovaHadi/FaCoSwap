...
if __name__ == '__main__':
    ...
    "Will you swap the whole face or face part?",
    ...
    st.title(':male-scientist: Welcome To FaCoSwap v1.3!')
    ...
    if file1 and file2 and col1.button("Swap face 1") :
        if add_selectbox2=='NDTS' and status1 and status2 and swap_type=='Face parts' :
            ...
            st.image(output)
        elif add_selectbox2=='NDT' and status1 and status2 and swap_type=='Face parts' :
            ...
            st.image(output)
        elif add_selectbox2=='NDS' and status1 and status2 and swap_type=='Face parts' :
            output = NDS_morphing(crop_img1, crop_img2, predictor)
            st.image(output)
        elif add_selectbox4=='whole face' and status1 and status2 and swap_type=='Whole face' :
    ...
    if  file1 and file2 and col2.button("Swap face 2") and swap_type=='Face parts':
